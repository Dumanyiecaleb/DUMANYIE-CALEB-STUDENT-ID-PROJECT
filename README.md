...
NAME: DUMANYIE - CALEB - BARISUA MATRIC NO : 24/15078  DEPARTMENT : COMPUTER - SCIENCE 
...
StudentRegistrationModule – handles student registration. 

IDCardGenerationModule – generates and displays ID cards. 

IDVerificationModule – verifies a student ID. 

MainMenu – allows user navigation between modules. 
...
Registers new students by taking Name, Matric, Department, and Level. 

IDCardGenerationModule 

Displays a formatted student ID card for each registered student. 

IDVerificationModule 

Checks if a student exists in the system using their Matric Number. 

MainMenu 

Provides a terminal-based menu to access all modules. 
...
Open terminal / command prompt and navigate to the folder containing the file. 
...
NAME: BEN - DUMANYIE - CALEB - BARISUA MATRIC NO : 24/15078 DEPARTMENT : COMPUTER - SCIENCE 
...
--- Register Student --- 
Enter Full Name: Ben Daniel 
Enter Matric Number: CU12345 
Enter Department: Computer Science 
Enter Level: 200 
Student Registered Successfully! 
...
https://github.com/bendaniel5446/SEN-201-SCHOOL-ID-CARD-/tree/main
